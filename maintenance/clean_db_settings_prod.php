...
try {
    ...
    if ($settings) {
        ...
        if (strpos($ticker, 'Bebas Ongkir Wilayah Gowa & Makassar') !== false || strpos($ticker, 'Gowa & Makassar') !== false || strpos($ticker, 'PROMO MERDEKA') !== false) {
            $newTicker = "⚡ Dapatkan perlengkapan IT, hardware, dan aksesoris komputer berkualitas tinggi dengan Garansi Resmi Distributor • Konsultasi Rakit PC & Layanan Ramah Terpercaya!";
