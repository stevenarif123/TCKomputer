...
try {
    ...
    if ($categoryCount === 0) {
        ...
        $faqs = [
            ...
            ['Produk & Garansi', 'Apakah semua produk bergaransi?', 'Semua produk yang kami jual dijamin 100% asli dan bergaransi toko. Informasi durasi garansi tercantum di halaman detail masing-masing produk.', 1, 1],
